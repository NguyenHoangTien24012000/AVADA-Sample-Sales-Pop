...
import apiWebhook from './handlers/webhookApi';
import clientApiApp from './handlers/clientApi';
...
export const webhook = functions.https.onRequest(apiWebhook.callback());

export const clientApi = functions.https.onRequest(clientApiApp.callback());
